                    ...
                    {(() => {
                      ...
                      return (
                        <div
                          ...
                          className="bg-white rounded-[22px] p-3 shadow-xl border border-[#DDE4D9] flex flex-col gap-2.5 cursor-pointer hover:border-[#40813D] transition-all"
                        >
                          <div className="flex gap-3 items-center">
                            <div className="relative w-18 h-18 rounded-[14px] overflow-hidden bg-[#E8FDE7] shrink-0">
                              <Image
            ...
            <div id="spa-detail-content" className="flex-1 overflow-y-auto pb-8">
              ...
              <div className="p-4 bg-white border-b border-[#DDE4D9]">
                ...
                <div className="h-36 rounded-[16px] overflow-hidden border border-[#DDE4D9] relative bg-[#ECEEE9]">
                  <GlowGoogleMap
                    spas={[detailSpa]}
                    selectedSpaId={detailSpa.id}
                    activePrice={activeService.price}
                    interactive={false}
                    className="w-full h-full"
                    initialCenter={{ lat: detailSpa.lat, lng: detailSpa.lng }}
                    initialZoom={15}
                  />
                </div>
              </div>
