...
export function LanguageSwitcher() {
  ...
  return (
    <div ref={containerRef} className="relative z-50 text-[13px]">
      <button
        type="button"
      ...
      {open && (
        <div className="absolute right-0 mt-2 w-48 rounded-2xl border border-stone-200 bg-white p-1.5 shadow-2xl animate-in fade-in slide-in-from-top-2 duration-150 text-stone-800 z-50">
          ...
          {LANGUAGE_OPTIONS.map((l) => {
            ...
            return (
              <button
                ...
                className={`flex w-full items-center justify-between rounded-xl px-2.5 py-2 text-left text-[13px] transition-colors cursor-pointer ${
                  isSelected
