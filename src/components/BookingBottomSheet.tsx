      ...
      >
        ...
        <div className="flex-none px-5 pt-3 pb-2.5 bg-white border-b border-stone-100 z-10">
          ...
          <div className="flex items-start justify-between">
            <div>
              <h3 className="text-[19px] font-bold text-[#093E06] leading-snug tracking-tight">
                {t.booking.title}
              </h3>
              <p className="text-[13.5px] text-[#6B7869] mt-0.5 font-medium">
                {spa ? `${spa.name} · ${spa.ward}` : spaName || t.booking.subtitle}
              </p>
            </div>
            <button
              onClick={handleClose}
              className="w-8.5 h-8.5 rounded-full bg-stone-100 flex items-center justify-center text-stone-500 hover:bg-stone-200 hover:text-stone-800 transition-colors cursor-pointer"
              aria-label={t.close}
            >
          ...
          <>
            ...
            >
                  ...
                  {serviceList.map((s) => {
                    ...
                    return (
                      <button
                        ...
                        className={`px-3.5 py-1.5 rounded-full text-[14px] font-medium transition-all cursor-pointer ${
                          isSelected
              ...
              <div>
                <div className="flex gap-2.5">
                  <div className="flex-1 min-w-0">
                    <label className="block text-[14px] font-semibold text-[#093E06] mb-1.5">
                      {t.booking.nameLabel}
                    </label>
                    <input
                      type="text"
                      ...
                      className="w-full box-border h-[48px] rounded-[14px] border border-[#DDE4D9] bg-white px-3.5 text-[15.5px] text-[#1E2B1C] placeholder:text-[#9BA69A] outline-none focus:border-[#40813F] transition-colors"
                    />
                  </div>
                  <div className="flex-1 min-w-0">
                    <label className="block text-[14px] font-semibold text-[#093E06] mb-1.5">
                    ...
                    <input
                      ...
                      className={`w-full box-border h-[48px] rounded-[14px] border px-3.5 text-[15.5px] text-[#1E2B1C] placeholder:text-[#9BA69A] outline-none transition-colors ${
                        phoneError && !phoneOk
                ...
                {phoneError && !phoneOk && (
                  <p className="text-[13px] text-[#C0392B] mt-1.5 font-medium">
              ...
              <div className="bg-[#F5F7F4] rounded-[18px] p-3.5 border border-[#E8ECE6]">
                <div className="flex items-center justify-between mb-2">
                  <span className="text-[12px] font-bold tracking-wider text-[#6B7869] uppercase">
                    {t.booking.messagePreviewTitle}
                  </span>
                  <button
                    type="button"
                    onClick={handleCopyPreview}
                    className={`inline-flex items-center gap-1 text-[13px] font-semibold rounded-full px-3 py-1 border transition-colors cursor-pointer ${
                      copied
                ...
                <div className="bg-[#E8FDE7] border border-[#D4F4D3] rounded-[14px] p-3 text-[14.5px] leading-relaxed text-[#1E2B1C] whitespace-pre-line font-medium">
                  {message}
                </div>
              </div>
            </div>
            ...
            <div className="flex-none bg-white border-t border-[#E8EDE6] px-5 pt-3 pb-5 shadow-[0_-4px_16px_rgba(0,0,0,0.06)] z-20">
              <button
                ...
                className="w-full bg-[#236B38] hover:bg-[#1D5A2E] active:scale-[0.99] text-white rounded-full h-13 flex items-center justify-center gap-2 font-bold text-[17px] shadow-md transition-all cursor-pointer"
              >
                <Image
